...
namespace CDDSS_API.Models.Domain
{
    ...
    partial void DeleteReview(Review instance);
		...
		public System.Data.Linq.Table<CriterionWeight> CriterionWeights
		{
			get
			{
    ...
    partial void OnAnswerChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CriterionWeight", Storage="_CriterionWeights", ThisKey="Id", OtherKey="User")]
		public EntitySet<CriterionWeight> CriterionWeights
		{
			get
			{
				return this._CriterionWeights;
			}
			set
			{
				this._CriterionWeights.Assign(value);
			}
		}
		...
		private void attach_CriterionWeights(CriterionWeight entity)
		{
			this.SendPropertyChanging();
			entity.User1 = this;
		}
    ...
    partial void OnWeightChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Criterion_CriterionWeight", Storage="_CriterionWeights", ThisKey="Id", OtherKey="Criterion")]
		public EntitySet<CriterionWeight> CriterionWeights
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CriterionWeight")]
	public partial class CriterionWeight : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnWeightChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Criterion_CriterionWeight", Storage="_Criterion1", ThisKey="Criterion", OtherKey="Id", IsForeignKey=true)]
		public Criterion Criterion1
		{
			get
			{
			...
			set
			{
							...
							|| (this._Criterion1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Criterion1.Entity = null;
						previousValue.CriterionWeights.Remove(this);
					}
					this._Criterion1.Entity = value;
					if ((value != null))
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CriterionWeight", Storage="_User1", ThisKey="User", OtherKey="Id", IsForeignKey=true)]
		public User User1
		{
			get
			{
